...
with st.sidebar:
    # Asegúrate de que la foto 'Miguel.jpg' esté en la carpeta
...
if opcion == "Hoja de Vida":
    ...
    st.markdown("""
    **Ingeniero Topográfico** con amplia experiencia en Sistemas de Información Geográfica (SIG), cartografía y análisis
    territorial. Especializado en levantamientos georreferenciados, restitución de territorios y desarrollo de herramientas
    tecnológicas para optimización catastral. Amplia trayectoria en control de calidad de levantamientos
    topográficos, aseguramiento de la precisión y cumplimiento normativo. Experiencia en la delimitación y análisis territorial
    ...
    with col_dl:
        try:
            # Asegúrate de que el archivo PDF se llame EXACTAMENTE así en tu carpeta
            ...
            st.warning("⚠️ Nota: Sube tu archivo 'HV_MiguelGuerrero.pdf' a la carpeta para activar este botón.")
